    ...
    <>
      <div
        ...
        <div className="mb-6 pb-4 border-b border-generic-border flex items-center">
          <SearchIcon className="h-5 w-5 mr-2 text-brand-primary" />
        ...
        {searchAuthors.length > 0 && (
          <div className="mb-6">
            <h4 className="text-sm font-medium text-muted mb-3 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-brand-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {searchAuthors.map(author => (
                <div
                  ...
                  className="bg-slate-800/40 rounded-md p-3 border border-generic-border hover:border-cyan-500/30 hover:bg-slate-800/60 cursor-pointer transition-all duration-200"
                  onClick={(e) => {
                    e.stopPropagation();
                    props.navigateToAuthor(author.id);
                  }}
